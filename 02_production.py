...
key = os.environ.get('AZURE_SEARCH_KEY', '2c1eb1502ebb4343990138e4a04f446a')
...
results = search_images_bing(key, 'grizzly bear',150)
...
ims = ['https://cdn.shopify.com/s/files/1/0261/4883/products/DSC02344_large.JPG?v=1571439131']
...
learn_inf.predict('images/teddy.jpg')
